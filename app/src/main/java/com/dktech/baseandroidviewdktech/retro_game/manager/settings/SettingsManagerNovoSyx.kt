package com.emulator.retro.console.game.retro_game.manager.settings
...
class SettingsManagerNovoSyx(private val context: Context, sharedPreferences: SharedPreferences) {

    private val sharedPreferences by lazy { FlowSharedPreferences(sharedPreferences) }
