...
class EmulairInputDeviceKeyboardNovoSyx(private val device: InputDevice) : EmulairInputDevice {

    override fun getCustomizableKeys(): List<RetroKeyNovoSyx> = InputDeviceManagerNovoSyx.Companion.OUTPUT_KEYS
